...
<head>
  ...
  <meta name="description" content="Sandogh Professional and Reliable Fund">
  <meta name="keywords" content="Fund web application, Money Saving, Lottery">
  <meta name="author" content="Parsi Teb">
  <title>Sandogh Details</title>
  ...
  <!-- BEGIN CSS-->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/css-rtl/vendors.css">
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/css-rtl/app.css">
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/css-rtl/custom-rtl.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/css-rtl/core/menu/menu-types/horizontal-menu.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/css-rtl/plugins/file-uploaders/dropzone.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/css-rtl/plugins/extensions/toastr.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/css-rtl/plugins/pickers/daterange/daterange.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>app-assets/fonts/simple-line-icons/style.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/style-rtl.css">
  <!-- END CSS-->


</head>
<body   class="horizontal-layout horizontal-menu 2-columns fund-detail-page menu-expanded" 
        data-open="hover"
