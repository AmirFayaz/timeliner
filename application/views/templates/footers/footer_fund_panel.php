  ...
  <script src="<?php echo base_url();?>app-assets/vendors/js/ui/prism.min.js" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url();?>app-assets/vendors/js/extensions/jquery.knob.min.js" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url();?>app-assets/vendors/js/gallery/photo-swipe/photoswipe-ui-default.js" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url();?>app-assets/js/scripts/popover/popover.js" type="text/javascript"></script>
  <script src="<?php echo base_url();?>app-assets/js/scripts/pickers/dateTime/bootstrap-datetime.js" type="text/javascript"></script>
  <script src="<?php echo base_url();?>app-assets/js/scripts/forms/select/form-select2.js" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url();?>app-assets/js/scripts/forms/input-groups.js" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url();?>app-assets/js/scripts/forms/extended/form-inputmask.js" type="text/javascript"></script>
  <script src="<?php echo base_url();?>app-assets/js/scripts/gallery/photo-swipe/photoswipe-script.js" type="text/javascript"></script>
    <!-- END JS-->

    <!-- Begin A-F JS -->
  <script src="<?php echo base_url();?>includes/jquery/scripts_utilities.js"></script>
  <script src="<?php echo base_url();?>includes/jquery/scripts_forms.js"></script>
  <script src="<?php echo base_url();?>includes/jquery/scripts_numbers.js"></script>
  <script src="<?php echo base_url();?>includes/jquery/scripts_number_format.js"></script>
  <script src="<?php echo base_url();?>includes/jquery/scripts_header.js"></script>
  <!-- END A-F JS -->
